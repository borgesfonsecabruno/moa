...
import moa.tasks.EvaluateNoveltyDetection;
 ...
 * @version $Revision: 7 $
 */
public class NDTaskManagerPanel extends JPanel {
    ...
    protected class TaskTableModel extends AbstractTableModel {
        ...
        public int getRowCount() {
            return NDTaskManagerPanel.this.taskList.size();
        }

        @Override
        public Object getValueAt(int row, int col) {
            TaskThread thread = NDTaskManagerPanel.this.taskList.get(row);
            switch (col) {
                case 0:
    ...
    protected MainTask currentTask = new EvaluateNoveltyDetection();
    ...
    public NDTaskManagerPanel() {
        // Read current task preference
        prefs = Preferences.userRoot().node(this.getClass().getName());
        currentTask = new EvaluateNoveltyDetection();
        ...
        this.configureTaskButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                String newTaskString = ClassOptionSelectionPanel.showSelectClassDialog(NDTaskManagerPanel.this,
                        "Configure task", NoveltyDetectionMainTask.class,
                        NDTaskManagerPanel.this.currentTask.getCLICreationString(NoveltyDetectionMainTask.class),
                        null);
                setTaskString(newTaskString);
            }
        });
        this.runTaskButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                runTask((Task) NDTaskManagerPanel.this.currentTask.copy());
            }
        });
        ...
        javax.swing.Timer updateListTimer = new javax.swing.Timer(
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                NDTaskManagerPanel.this.taskTable.repaint();
            }
        });
    ...
    public void setPreviewPanel(NDPreviewPanel previewPanel) {
    ...
    private static void createAndShowGUI() {
        ...
        JPanel panel = new NDTaskManagerPanel();
